            ...
            <div class="row">
                ...
                <div class="col d-flex justify-content-end">
                    <div class="d-flex align-items-center me-4">
                        <button type="button" class="btn btn-primary"  onclick="window.location.href='{{route('staff.consultant.create')}}'">Add New</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                @if (!$datas->isEmpty())
                    ...
                    @foreach ($datas as $data)
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="text-sm font-weight-bold mb-0">
                                    {{$data['department']['value']}}</p>
                            </td>
                            <td>
                                <p class="text-sm font-weight-bold mb-0">
                                    {{$data['location']['value']}}</p>
                            </td>
                            <td>
                                <p class="text-sm font-weight-bold mb-0">
                                    {{$data->phoneNo}}</p>
