        ...
        <div class="col-lg-8 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('staff.consultant.update', ['id' => $consultant->id]) }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name"
                                            placeholder="Name" disabled value="{{$consultant->name}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="phoneNo" class="form-control" name="phoneNo"
                                            placeholder="phoneNo" disabled value="{{$consultant->phoneNo}}">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" class="form-control" name="email"
                                            ...
                                            disabled value="{{$consultant->email}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="IcNum">IC Number</label>
                                        <input type="text" id="IcNum" class="form-control" name="IcNum"
                                            placeholder="IcNum" disabled value="{{$consultant->IcNum}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="location" class="form-control" name="location"
                                            placeholder="location" disabled value="{{$consultant->location->value}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="department" class="form-control" name="department"
                                            placeholder="department" disabled value="{{$consultant->department->value}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col text-center">
                                    <button type="submit" class="btn btn-primary" onclick="window.location.href='{{ route('staff.consultant.manage') }}'">Back</button>
                                </div>
                            </div>
                        </div>
                    </form>
