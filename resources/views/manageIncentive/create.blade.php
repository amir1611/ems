                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="department">Job</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="department">job type</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="phoneNo">Salary</label>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label" for="email">Date<span
                                                class="small text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="department">Status</label>
                                        <input type="text" id="IcNum" class="form-control" name="IcNum"
                                            placeholder="IcNum">
                                    </div>
