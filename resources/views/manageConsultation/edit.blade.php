                    ...
                    <div class="card-header py-2">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group focused">
                                                    ...
                                                    <input type="date" id="date" class="form-control"
                                                        name="date" placeholder="date" value="{{ $data['date'] }}"
                                                        disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group focused">
                                                    ...
                                                    <input type="text" id="slot" class="form-control"
                                                        name="slot" placeholder="slot" value="{{ $data['slot']['value'] }}"
                                                        disabled>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="location" class="form-control"
                                                        ...
                                                        value="{{ $data['location']['value'] }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    <a href="{{ route('staff.consultation.decline', ['id' => $data['id']]) }}"
